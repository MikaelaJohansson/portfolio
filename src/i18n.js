...
const resources = {
  en: {
    translation: {
      ...
      "Färdigheter": "Skills",
      "4": "One of my projects that reflects my current skill level. The project is a chat application where users can create an account, log in, write and post messages.",
      "5": "The application includes: Vite, APIs, Git/GitHub, password protection, CSRF Token, JWT, Session/LocalStorage, CSP policy, log monitoring with Sentry, DomPurify, protected routing, Crypto.randomUUID, and images hosted on freeimage.",
  ...
  sv: {
    "translation": {
      ...
      "4": "Ett av mina projekt som speglar min nuvarande kompetensnivå. Projektet är en chattapplikation där användare kan skapa ett konto, logga in, skriva och posta meddelanden. ",
      "5":" Applikationen innehåller: Vite, API:er, Git/GitHub, lösenordsskyddad, CSRF-Token, JWT, Session-/LocalStorage, CSP-policy, monitorering av loggar på Sentry, DomPurify, protected routing, Crypto.randomUUID och bilder hostas på freeimage.",
